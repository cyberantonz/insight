...
ALWAYS open and follow `.cf-studio/config/rules/conventions.md` WHEN writing or reviewing spec documents

ALWAYS open and follow `.cf-studio/config/rules/architecture.md` WHEN modifying pipeline architecture, adding new sources, or refactoring Bronze/Silver/Gold layers
